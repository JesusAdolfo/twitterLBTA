...
//  TwitterLBTA
//
//  Created by Jesus Adolfo on 2/6/17.
//
//
...
class TweetCell: DatasourceCell {
    ...
    override var datasourceItem: Any? {
        didSet {
            ...
            attributedText.append(NSAttributedString(string: username, attributes: [NSFontAttributeName: UIFont.systemFont(ofSize: 15), NSForegroundColorAttributeName: UIColor.gray]))
...
//        replyButtonContainer.backgroundColor = .red
        
        let retweetButtonContainer = UIView()
//        retweetButtonContainer.backgroundColor = .blue
        
        let likeButtonContainerView = UIView()
//        likeButtonContainerView.backgroundColor = .purple
        
        let directMessageButtonContainerView = UIView()
//        directMessageButtonContainerView.backgroundColor = . green
        

        
        let buttonStackView = UIStackView(arrangedSubviews: [replyButtonContainer, retweetButtonContainer, likeButtonContainerView, directMessageButtonContainerView])
